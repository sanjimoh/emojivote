...
import (
	...
	"github.com/buoyantio/emojivoto/emojivote-emoji-svc/api"
	"github.com/buoyantio/emojivoto/emojivote-emoji-svc/emoji"
...
var (
	grpcPort    = os.Getenv("EMOJI_SVC_PORT_8020_TCP_PORT")
