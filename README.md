...
* [emojivote-emoji-svc](emojivote-emoji-svc/): gRPC API for finding and listing emoji
* [emojivote-voting-svc](emojivote-voting-svc/): gRPC API for voting and leaderboard
