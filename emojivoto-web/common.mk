...
protoc:
	protoc --go_out=plugins=grpc:gen --proto_path=proto
...
build-multi-arch:
	docker buildx build .. -t "asia-docker.pkg.dev/my-kubernetes-cluster-224712/asia.gcr.io/$(svc_name):$(IMAGE_TAG)" --build-arg svc_name=$(svc_name) \
